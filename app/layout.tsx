...
export const metadata: Metadata = {
  ...
  description:
    'Appu S R is a Chennai-based devotional fiction author. Her debut Kindle book SundaraKandam: Hanuman\'s Divine Mission retells the Ramayana\'s most uplifting chapter for modern readers.',
  keywords:
